		...
		<div class="col-12 mx-auto">
			<form:form action="/property/${editProperty.id}/update" method="put"
				...
				<div class="form-group">
					...
					<form:textarea path="description" class="form-control text-primary fst-italic h-25" rows="3" />
				</div>
				<div class="form-group">
					<form:label path="rentalType" class="py-2">Rental Type: </form:label>
					<form:errors path="rentalType" class="text-danger" />
					<form:input path="rentalType" class="form-control text-primary fst-italic h-25" rows="3" />
				</div>
				<div class="form-group">
