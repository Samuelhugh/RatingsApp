...
<body class="body-bg">
		...
		<div class="mt-2 mx-4 mb-3 text-center nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-transparent">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						<li class="m-1 nav-item font-weight-normal"><a class="nav-link font-weight-normal" href="/dashboard">DASHBOARD
							</a></li>
						<li class="m-1 nav-item font-weight-normal"><a class="nav-link font-weight-normal" href="/property/new">ADD
								RENTAL</a></li>
						<li class="m-1 nav-item font-weight-normal"><a class="nav-link font-weight-normal" href="/">SIGN OUT</a></li>
					</ul>
				</div>
			</nav>
		</div>
	...
	<div class="card container bg-transparent mt-4 mb-4 p-4">
		<div class="d-flex col-12 mx-auto justify-content-between">
			<div class="my-3">
				<h2 class="font-weight-light">Edit Rental</h2>
			</div>
		</div>
		<div class="col-12 mx-auto">
			<form:form action="/property/${editProperty.id}/update" method="put"
				...
				<input type="submit" value="Confirm Edit" class="btn btn-outline-dark mx-1 my-3">
			</form:form>
		</div>
	</div>
</body>
