...
<body class="body-bg">
		...
		<div class="mt-2 mx-4 mb-3 text-center nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-transparent">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						<li class="m-1 nav-item font-weight-normal"><a class="nav-link"
							href="/dashboard">DASHBOARD </a></li>
						<li class="m-1 nav-item font-weight-normal"><a class="nav-link"
							href="/property/new">ADD RENTAL</a></li>
						<li class="m-1 nav-item font-weight-normal"><a class="nav-link" href="/">SIGN
								OUT</a></li>
					</ul>
				</div>
			</nav>
	...
	<div>
		<div
			class="card container d-flex col-12 mx-auto justify-content-between bg-transparent mt-4 mb-2 p-4">
		...
		<table class=" table table-hover">
			...
			<tbody>
				<c:forEach items="${property}" var="properties">
					<tr>
						<td><a href="/property/${ properties.id }"> <img
								src="${ properties.imageUrl }" class="img-thumbnail img-sml"
								alt="${ properties.rentalType }" />
						</a></td>
						<td class="align-middle">${ properties.addressLine1},${ properties.city },
							${ properties.state }</td>
