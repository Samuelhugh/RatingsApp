						...
						<div class="card container mt-4 mb-4 p-4 bg-transparent">
							...
							<div class="my-3 row align-items-center">
								<div class="row g-3 mx-2 my-2">
									...
									<div class="col-6">${ property.addressLine1 }, ${ property.city }, ${ property.state
										}</div>
								</div>
								<div class="row g-3 mx-2 my-2">
									<div class="col-3">
...
<!-- 								<div class="row g-3 mx-2 my-2">
								...
								<div class="d-flex col-9 mt-3 my-2">
									<a href="/property/${ property.id}/ratings" class="btn btn-outline-primary mx-2">Rate & Comment</a>
